...
data_2d[2] = 9
print(f"data = {data_2d}")
print(f"data copy = {data_2d_copy}") # copy() -> menyalin tidak dalam, artinya yang bukan list dapat disalin sedangkan yang berada dalam list tidak
...
print("address dari member ke-2")
print(f"address asli = {hex(id(data_2d[0]))}")
