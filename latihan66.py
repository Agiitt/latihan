...
# contoh aplikasi untuk membuat file latihan66.txt 
try:
    with open("latihan66.txt",'r') as file:
        print(file.read())
except:
    print("file latihan66.txt tidak ditemukan, membuat file baru")
    with open("latihan66.txt",'w',encoding='utf-8') as file:
